...
import { InputUi, ButtonUi, PasswordInputUi } from "components/UI";
...
const SignIn = () => {
    ...
    const makeIsHave = (data) => {
        ...
        if (data?.role === UsersRole.admin) navigate("/admin/tests");
    };
        ...
        <SignInMain>
            <SignInBox>
                <SignInWrapper>
                    ...
                    <IsAccaunt>
                        АККАУНТУҢУЗ жокпу? <Link to={RoutesUrl.SignUp}>Катталуу</Link>
                    </IsAccaunt>
                </SignInWrapper>
            </SignInBox>
        </SignInMain>
